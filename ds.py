...
def dashboard():
    ...
    st.markdown("""
        <div style="display: flex; align-items: center;">
            ...
            <h5 style="font-family: 'Khmer OS Muol Light', Arial, sans-serif; margin-top: 0; font-size: 18px; font-weight: bold; vertical-align: middle;">Fisheries Information Management System (FIMS)</h5>
        </div>
    </div>
    <br><br>
""", unsafe_allow_html=True)
